...
const AuthenticationScreen: React.FC = () => {
  ...
  return (
    <NavLayout title={"Authentication"}>
            ...
            >
              <View className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-white/50 dark:border-gray-700/50 overflow-hidden">
                ...
                <View className="flex-row bg-gray-50/80 dark:bg-gray-900/80 backdrop-blur-sm">
                  ...
                  >
                    <Text
                      className={`text-center font-bold text-lg ${isLogin ? "text-blue-600 dark:text-blue-400" : "text-gray-400 dark:text-gray-500"}`}
                    >
                      Login
                    </Text>
                  </Pressable>
                  ...
                  >
                    <Text
                      className={`text-center font-bold text-lg ${!isLogin ? "text-purple-600 dark:text-purple-400" : "text-gray-400 dark:text-gray-500"}`}
                    >
                      Register
                    </Text>
                  </Pressable>
                ...
                <View className="p-6">
                  ...
                  <View className="mb-5">
                    ...
                    <View
                      className={`flex-row items-center bg-gray-50 dark:bg-gray-700/50 rounded-xl px-4 py-3.5 border-2 ${errors.email ? "border-red-500" : "border-gray-200 dark:border-gray-600"}`}
                    >
                  ...
                  <View className="mb-5">
                    ...
                    <View
                      className={`flex-row items-center bg-gray-50 dark:bg-gray-700/50 rounded-xl px-4 py-3.5 border-2 ${errors.password ? "border-red-500" : "border-gray-200 dark:border-gray-600"}`}
                    >
                      <Text className="text-gray-400 dark:text-gray-500 mr-3 text-xl">
                        🔒
                      </Text>
                  ...
                  {!isLogin && (
                    <View className="mb-5">
                      ...
                      <View
                        className={`flex-row items-center bg-gray-50 dark:bg-gray-700/50 rounded-xl px-4 py-3.5 border-2 ${errors.confirmPassword ? "border-red-500" : "border-gray-200 dark:border-gray-600"}`}
                      >
                        <Text className="text-gray-400 dark:text-gray-500 mr-3 text-xl">
                          🔐
                        </Text>
                  ...
                  <View className="flex-row items-center justify-around">
                    ...
                    <View className="items-center">
                      <View className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full items-center justify-center mb-2 shadow-lg">
                        <Text className="text-purple-600 dark:text-purple-400 font-bold text-xl">
                          🔐
                        </Text>
                      </View>
                      <Text className="text-xs text-gray-600 dark:text-gray-400 font-bold">
                    ...
                    <View className="items-center">
                      <View className="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-full items-center justify-center mb-2 shadow-lg">
                        <Text className="text-blue-600 dark:text-blue-400 font-bold text-xl">
                          ✓
                        </Text>
                      </View>
                      <Text className="text-xs text-gray-600 dark:text-gray-400 font-bold">
